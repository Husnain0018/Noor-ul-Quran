          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            {filtered.map((surah) => (
              <Link
                ...
                className="rounded-xl p-5 bg-card border border-border hover:shadow-md transition-all group"
              ...
              >
                <div className="flex items-start justify-between">
                  ...
                  <div className="text-right">
                    <p className="text-lg font-bold text-foreground" style={{ fontFamily: "'Amiri', 'Scheherazade New', serif" }}>
                      {surah.name}
                    </p>
